        ...
        <>
            <div className="rounded rounded-3xl bg-white grow p-6 flex">
                <div className="container mx-auto relative grow">
                    <div className="flex flex-col w-full h-full items-center">
                        <div className="flex flex-row w-full pb-3 border-b-2 items-center justify-between">
                            <div className="flex flex-row gap-4 items-center">
                                <div className="flex flex-row items-baseline align-baseline h-10 bg-amber-50">
                                    <img
                                        src="logo-alt.png"
                                        alt=""
                                        className="h-full"
                            ...
                            <div className="flex flex-row gap-2 items-center">
                                <button
                                    className="text-sm bg-white text-black font-medium border-2 border-black py-2 px-4 rounded-lg"
                        ...
                        <div
                            ref={chatBoxRef}
                            className="messages w-full overflow-y-auto overflow-x-clip mb-4 p-4 rounded-2xl mt-4"
                            style={{ backgroundImage: "url('/bg/layers-white.jpg')" }}
                        >
                            {(
                                messages.map((message, index) => (
                                    index % 2 === 0
                                    ? <Slide direction="right" delay={150} duration={750} triggerOnce cascade>
                                        <div
                                            key={index}
                                            className={`mb-2 ${
                                                index % 2 === 0
                    ...
                    <div className="chatbox flex flex-row justify-between items-center gap-2 absolute bottom-10 w-full px-6 py-2 border-2 border-black rounded-2xl">
                        <button
                            className={
                                isMicOn
                        ...
                        <input
                            ...
                            name="message"
                            id="message"
                            className="py-2 px-6 placeholder-zinc-500 font-medium focus:outline-none rounded-md hover:placeholder-black grow rounded-lg"
                        ...
                        />
                        <button
                            className="text-white bg-black font-medium p-2 rounded-lg cursor-pointer"
                    ...
                    <p className="text-center text-zinc-500 font-medium absolute bottom-0 w-full">
                        CAI v0.0.5 | Prototype Project |{" "}
                        <a
                            href="https://github.com/DevT75/cai_grid"
